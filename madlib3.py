...
'''
    ...
    filename = input("Choose a name the file to contain the madlib string")
    newfilename = filename + '.txt'
    outFile = open(newfilename, 'w')
    
    outFile.write(originalStoryFormat)
    outFile.close()

    outFile = open(newfilename, 'r')
